  ...
  export default {
    setup() {
      ...
      const fetchReportHistory = async () => {
        ...
        try {
          const response = await reportService.getReportHistory(startDate.value, endDate.value);
          ...
          reports.value = [
            ...
            },
            {
              ...
              date: '2025-03-16',
              total_sales: 1320.50,
              total_payments: 1320.50,
              total_discounts: 95.20,
              payment_breakdown: 'Cash: 520.30, Card: 800.20'
            }
          ];
      ...
      const createSalesChart = () => {
        ...
        const salesData = sortedReports.map(report => parseFloat(report.total_sales));
        const discountData = sortedReports.map(report => parseFloat(report.total_discounts));
